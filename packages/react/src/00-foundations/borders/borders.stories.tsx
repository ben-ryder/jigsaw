  ...
  return (
    <div className="j-content-section">
      <div className="j-prose">
        <h1>Borders</h1>
        <p>Jigsaw provides a number of predefined width and radius values for borders.</p>

        <h2>Border Radius</h2>
        <p>In Jigsaw, the small radius can be used on UI elements like panels to soften up the edges, and the
        ...
        <h2>Border Width</h2>
        <p>The small width can be used in most situations. The medium width is most notably used for form elements
