  ...
  return (
    <div className="j-content-section">
      <div className="j-prose">
        <h1>Colours</h1>
        <p>
          The <strong>atom</strong> colour palette is the most important and is
          the main colour used for the background and interface. The{" "}
          <strong>teal</strong> colour palette is the next most important and is
          the main "brand" colour of the design system.
        </p>

        <h2>Accessibility</h2>
        <p>
          Accessibility is important and all use of colour in Jigsaw must at
          least meet{" "}
          <a href="https://www.w3.org/TR/UNDERSTANDING-WCAG20/visual-audio-contrast-contrast.html">
            WCAG AA guidelines
          </a>
          . All colour palettes in Jigsaw have been selected with this in mind,
          but care must be taken to ensure these colours are used correctly when
          combined.
        </p>
          ...
          <tbody>
            {colours.map((colour) => {
              return (
                <tr key={colour.value}>
                  <td>
                    <span style={{ backgroundColor: colour.value }}></span>
                  </td>
                  <td>
                    <code>{colour.identifier}</code>
                  </td>
                  <td>
