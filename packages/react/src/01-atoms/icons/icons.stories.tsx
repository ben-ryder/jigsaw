  ...
  return (
    <div className="j-content-section">
      <div className="j-prose">
        ...
        <p>The <code>{`<JIcon/>`}</code> component allows icon colour and size to be controlled, for example:</p>
        <pre>
          <code>{`<JIcon variant="red" size="md"><BinIcon /></JIcon>`}</code>
        </pre>

        <h3>Icon Sizes</h3>
        <p>Icon sizes directly match with the <a href="/?path=/story/foundations-typography--typography">text sizes</a> also defined in Jigsaw.</p>
        ...
        <h3>Icon Variants</h3>
        <p>Icon variants can be used to changes the colour of icons, these colours are taken from <a href="/?path=/story/foundations-colours--colours">Jigsaw's colour variables</a>.</p>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>orange</code></td><td><JIcon size="lg" variant="orange"><SmileIcon/></JIcon></td></tr>
            <tr><td><code>yellow</code></td><td><JIcon size="lg" variant="yellow"><SmileIcon/></JIcon></td></tr>
            <tr><td><code>blue</code></td><td><JIcon size="lg" variant="blue"><SmileIcon/></JIcon></td></tr>
            <tr><td><code>purple</code></td><td><JIcon size="lg" variant="purple"><SmileIcon/></JIcon></td></tr>
            <tr><td><code>pink</code></td><td><JIcon size="lg" variant="pink"><SmileIcon/></JIcon></td></tr>
          </tbody>
        </table>
