...
import {JCallout} from "../../03-components/callout/callout";

const meta = {
  title: 'Atoms/Prose',
  component: JProse,
  tags: ['autodocs'],
} satisfies Meta<typeof JProse>;
  ...
  args: {
    children: (
      <>
        ...
        <p>
          I'm lazy so this is the same testing text that I used when I was using
          Tailwind for styling, so this text is copied from the{" "}
          <code>@tailwindcss/typography</code>
          package. As such, you can ignore any Tailwind references they don't mean
          anything.
        </p>
        ...
        <p>
          ...
          element I could think of, like
          <strong>bold text</strong>, unordered lists, ordered lists, code blocks,
          block quotes, <em>and even italics</em>.
        </p>
