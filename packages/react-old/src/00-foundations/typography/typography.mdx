...
<Documentation>
  ...
  ## Font Weights
  <p className="j-text-normal"><code>j-text-weight-normal | 400</code> - Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
  <p className="j-text-medium"><code>j-text-weight-medium | 500</code> - Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
  <p className="j-text-bold"><code>j-text-weight-bold | 700</code> - Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
