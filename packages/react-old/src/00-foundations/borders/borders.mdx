...
<Documentation>
    ...
    <StorySection>
        <div className="border-item border-item--j-radius-sm">
            <p>Small (4px)</p>
            <code>j-border-radius-sm</code>
        </div>
        <div className="border-item border-item--j-radius-md">
            <p>Medium (6px)</p>
            <code>j-border-radius-md</code>
        </div>
        <div className="border-item border-item--j-radius-lg">
            <p>Large (8px)</p>
            <code>j-border-radius-lg</code>
        </div>
        <div className="border-item border-item--j-radius-xl">
