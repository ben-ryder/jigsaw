    ...
    <div className="j-content-section">
      <div className="j-prose">
        ...
        <ul>
          ...
          <li><code>$j-c-background-b1</code> - The first layer below the main content, can be used for a
        ...
        <p>There are also two mid-layer
          shades <code>$j-c-background-b0</code> and <code>$j-c-background-f0</code> which can be used when
          required.<br/>
          For example, tables in the <code>Prose</code> component have a background
          of <code>var(--j-c-background-f1)</code> but every other
          row has a background of <code>$j-c-background-f0</code> as this makes the table easier to read.
        </p>
