...
export function processButtonStyling(props: ButtonProps) {
  ...
  return classNames(
    ...
    "transition-colors",
    {
      ...
      'border-br-whiteGrey-50 hover:border-br-whiteGrey-200': status === 'normal' && styling === 'secondary',
      ...
      'bg-br-whiteGrey-50 text-br-whiteGrey-800 hover:bg-br-whiteGrey-200': status === 'normal' && variant === 'solid' && styling === 'secondary',
      ...
      'text-br-whiteGrey-50 hover:text-br-whiteGrey-200': status === 'normal' && variant === 'outline' && styling === 'secondary',
